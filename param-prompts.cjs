...
const content = `import type { IntelligenceContext } from "../types/intelligence-context";
...
fs.writeFileSync('src/features/geopolitical-intelligence/prompts/module-prompts.ts', content);
console.log('Prompts parameterized');
