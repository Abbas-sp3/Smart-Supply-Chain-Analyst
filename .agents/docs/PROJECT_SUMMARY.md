...
Welcome to the **Energy Supply Chain Resilience Platform** project! This document serves as the comprehensive source of truth for any developer or AI agent working on this repository. It outlines the project's purpose, architectural principles, folder responsibilities, and contains a strictly enforceable requirement for documenting AI task history.
...
## 🎯 Project Overview
**Energy Supply Chain Resilience Platform** is an AI-driven Energy Supply Chain Resilience Intelligence Platform designed specifically for import-dependent economies. It provides real-time interactive energy supply chain simulation, intelligence, and procurement decision support. The platform enables energy security analysts and risk managers to monitor global energy shipping lanes, assess geopolitical risks to energy supply, simulate energy disruption scenarios, track strategic energy reserves, and optimize energy commodity procurement for economies with high import dependency.
...
| 2026-07-09 | Modular Intelligence Architecture | [intelligenceService.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/services/intelligenceService.ts), [intelligenceContextService.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/services/intelligenceContextService.ts), [moduleCacheService.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/services/moduleCacheService.ts), [reportAssembler.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/services/reportAssembler.ts), [module-prompts.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/prompts/module-prompts.ts), [module-schemas.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/schemas/module-schemas.ts), 5 module files under `modules/`, [types/intelligence-context.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/types/intelligence-context.ts), [types/module-outputs.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/types/module-outputs.ts), [README.md](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/README.md) | Replaced monolithic Groq dashboard generation with 5 independent reasoning modules (Executive Summary, Supply Chain Impact, Recommendations, Scenario Analysis, Evidence). Introduced compact IntelligenceContext, per-module caching with independent TTLs, SupplyChainFact deduplication via reportAssembler, and concise per-module prompts (≤500 words). Reduced prompt size ~60%+ by never sending raw API payloads to Groq. Frontend unchanged — React renders assembled IntelligenceReport. npm run build, lint, and dev all pass. | Cursor (Claude Sonnet) |
| 2026-07-09 | Procurement API Fix | [procurementService.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/procurement/services/procurementService.ts), [procurement/route.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/app/api/procurement/route.ts), [procurement/page.tsx](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/app/procurement/page.tsx), types/schemas/constants/prompts under `features/procurement/` | Fixed procurement 500 errors caused by Groq 429 rate limits on llama-3.3-70b (5k-token monolithic prompt competing with intelligence modules). Refactored into procurementService with compact prompt, llama-3.1-8b-instant (separate rate pool), 30-min cache, NewsAPI mock fallback, and curated mock briefing when Groq is unavailable. Dashboard now loads reliably even at daily token cap. | Cursor (Claude Sonnet) |
| 2026-07-09 | Gemini LLM Fallback Layer | [llmRouter.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/services/llm/llmRouter.ts), [geminiProvider.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/services/llm/geminiProvider.ts), [groqProvider.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/services/llm/groqProvider.ts), [groqService.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/services/groqService.ts), [.env.example](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/.env.example) | Added provider-agnostic LLM router with Groq primary and Gemini (`gemini-2.5-flash`) automatic fallback on rate limit, token limit, timeout, service unavailable, and network errors. Existing `callGroq()` callers unchanged. Logs provider, fallback, execution time, and retry count server-side only. | Cursor (Claude Sonnet) |
| 2026-07-09 | LLM Response Normalization Layer | [responseNormalizer.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/services/llm/responseNormalizer.ts), [normalization-profiles.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/services/llm/normalization-profiles.ts), [moduleRunner.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/modules/moduleRunner.ts), [intelligenceService.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/services/intelligenceService.ts), [preprocessingService.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/services/preprocessingService.ts), [procurementService.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/procurement/services/procurementService.ts), [module-prompts.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/prompts/module-prompts.ts) | Added response normalizer between LLM output and Zod validation. Maps camelCase/alternative property names, fills missing fields with sensible defaults, coerces invalid enums. Dev-only logging for raw/normalized/repaired fields. Updated module prompts with strict JSON rules. Dashboard no longer crashes on omitted LLM fields. | Cursor (Claude Sonnet) |
| 2026-07-09 | Truncated JSON Recovery | [jsonRepair.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/services/llm/jsonRepair.ts), [moduleRunner.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/modules/moduleRunner.ts), [constants/index.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/constants/index.ts) | Fixed intelligence generation failures caused by token-truncated JSON (recommendations/scenario modules). Added JSON repair for cut-off responses, per-module token limits up to 3584, compact-output retry, and empty-profile fallback instead of aborting. Dashboard continues rendering even when a module LLM call returns incomplete JSON. | Cursor (Claude Sonnet) |
| 2026-07-09 | NewsFact join crash fix | [preprocessingService.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/services/preprocessingService.ts), [normalization-profiles.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/services/llm/normalization-profiles.ts) | Fixed `Cannot read properties of undefined (reading 'join')` in preprocessing when LLM omitted `keywords`/`affected_products`/`affected_trade_routes` on news facts. Added `facts` array item template for normalizer and `sanitizeNewsFact` + safeJoin guards. | Cursor (Claude Sonnet) |
| 2026-07-12 | Energy Supply Chain Resilience Update | [app.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/lib/constants/app.ts), [navigation.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/lib/constants/navigation.ts), [layout.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/lib/constants/layout.ts), [procurement types/schemas/prompts/constants/mock/services](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/procurement/), [live-price/route.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/app/api/procurement/live-price/route.ts), [price-history/route.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/app/api/procurement/price-history/route.ts), [procurement/route.ts](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/app/api/procurement/route.ts), [procurement/page.tsx](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/app/procurement/page.tsx), [geopolitical-intelligence/constants](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/src/features/geopolitical-intelligence/constants/index.ts), [PROJECT_SUMMARY.md](file:///c:/Users/Abbas/Smart-Supply-Chain-Analyst/.agents/docs/PROJECT_SUMMARY.md) | Full codebase update to refocus from general supply chain to AI-driven energy supply chain resilience for import-dependent economies. Updated APP_NAME, navigation labels, workspace panels. Converted procurement feature to energy-only (types, schemas, prompts, mock data, services). Updated live-price API to filter/fetch only energy commodities. Extended price-history API to support multiple energy series (Brent, WTI, Natural Gas, Heating Oil). Rewrote procurement API route with energy-focused Gemini prompt and schema. Redesigned procurement page with import dependency metrics, energy commodity price grid, comparison bar chart, dependency pie chart, multi-series price forecast, and energy sourcing options. Updated geopolitical intelligence keywords for energy focus. | opencode (DeepSeek V4) |
